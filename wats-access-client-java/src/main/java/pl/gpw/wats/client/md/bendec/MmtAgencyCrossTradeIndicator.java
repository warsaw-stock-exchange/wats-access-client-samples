...
public enum MmtAgencyCrossTradeIndicator {
    ...
    /**
     Get MmtAgencyCrossTradeIndicator from java input
     * @param newValue
     * @return MmtAgencyCrossTradeIndicator enum
     */
    public static MmtAgencyCrossTradeIndicator getMmtAgencyCrossTradeIndicator(int newValue) {
        MmtAgencyCrossTradeIndicator val = TYPES.get(newValue);
        return val == null ? MmtAgencyCrossTradeIndicator.UNKNOWN : val;
    }
     ...
     * @return int value
     */
    public int getMmtAgencyCrossTradeIndicatorValue() { return value; }

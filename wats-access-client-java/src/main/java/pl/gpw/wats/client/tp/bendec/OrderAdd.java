...
public class OrderAdd implements ByteSerializable, Message {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(header, onBehalfOf, stpId, instrumentId, orderType, timeInForce, side, price, triggerPrice, quantity, displayQty, capacity, account, accountType, mifidFields, expire, memo, clearingMemberCode, clearingMemberClearingIdentifier);
    }

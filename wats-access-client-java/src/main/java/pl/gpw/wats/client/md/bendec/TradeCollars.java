...
public class TradeCollars implements ByteSerializable, Message {
    ...
    public TradeCollars(Header header, long instrumentId, CollarType collarType, long price, long lower, long upper) {
        ...
        this.header.setMsgType(MsgType.TRADECOLLARS);
    }
    ...
    public TradeCollars(byte[] bytes, int offset) {
        ...
        this.lower = BendecUtils.int64FromByteArray(bytes, offset + 52);
        this.upper = BendecUtils.int64FromByteArray(bytes, offset + 60);
        this.header.setLength(this.byteLength);
        this.header.setMsgType(MsgType.TRADECOLLARS);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(header, instrumentId, collarType, price, lower, upper);
    }

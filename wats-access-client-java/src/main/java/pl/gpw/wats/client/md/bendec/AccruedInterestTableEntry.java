...
public class AccruedInterestTableEntry implements ByteSerializable, Message {
    ...
    public AccruedInterestTableEntry(Header header, long productId, long accruedInterestTableEntryDate, long accruedInterestTableEntryValue) {
        ...
        this.header.setMsgType(MsgType.ACCRUEDINTERESTTABLEENTRY);
    }
    ...
    public AccruedInterestTableEntry(byte[] bytes, int offset) {
        ...
        this.accruedInterestTableEntryDate = BendecUtils.uInt32FromByteArray(bytes, offset + 43);
        this.accruedInterestTableEntryValue = BendecUtils.int64FromByteArray(bytes, offset + 47);
        this.header.setLength(this.byteLength);
        this.header.setMsgType(MsgType.ACCRUEDINTERESTTABLEENTRY);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(header, productId, accruedInterestTableEntryDate, accruedInterestTableEntryValue);
    }

...
public class TestEvent implements ByteSerializable, Message {
    ...
    public static final int byteLength = 243;
    ...
    public TestEvent(byte[] bytes, int offset) {
        ...
        this.scenarioName = BendecUtils.stringFromByteArray(bytes, offset + 42, 200);
        this.eventType = EventType.getEventType(bytes, offset + 242);
    }

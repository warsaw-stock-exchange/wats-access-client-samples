...
public class TestEvent implements ByteSerializable, Message {
    ...
    public static final int byteLength = 240;
    ...
    public TestEvent(Header header, String scenarioName, EventType eventType) {
        ...
        this.header.setMsgType(MsgType.TESTEVENT);
    }

    public TestEvent(byte[] bytes, int offset) {
        this.header = new Header(bytes, offset);
        this.scenarioName = BendecUtils.stringFromByteArray(bytes, offset + 39, 200);
        this.eventType = EventType.getEventType(bytes, offset + 239);
        this.header.setLength(this.byteLength);
        this.header.setMsgType(MsgType.TESTEVENT);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(header, scenarioName, eventType);
    }

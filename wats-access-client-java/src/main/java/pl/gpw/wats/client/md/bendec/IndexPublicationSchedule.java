...
public enum IndexPublicationSchedule {
    ...
    /**
     Get IndexPublicationSchedule from java input
     * @param newValue
     * @return IndexPublicationSchedule enum
     */
    public static IndexPublicationSchedule getIndexPublicationSchedule(int newValue) {
        IndexPublicationSchedule val = TYPES.get(newValue);
        return val == null ? IndexPublicationSchedule.UNKNOWN : val;
    }
     ...
     * @return int value
     */
    public int getIndexPublicationScheduleValue() { return value; }

...
public class Header implements ByteSerializable {
    ...
    public Header(int length, MsgType msgType, int version, long seqNum, BigInteger timestamp, BigInteger sourceTimestamp, boolean isEncrypted, BigInteger encryptionOffset, long encryptionKeyId) {
        this.length = length;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(length, msgType, version, seqNum, timestamp, sourceTimestamp, isEncrypted, encryptionOffset, encryptionKeyId);
    }

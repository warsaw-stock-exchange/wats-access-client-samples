...
public enum TradeType {
    ...
    /**
     Get TradeType from java input
     * @param newValue
     * @return TradeType enum
     */
    public static TradeType getTradeType(int newValue) {
        TradeType val = TYPES.get(newValue);
        return val == null ? TradeType.UNKNOWN : val;
    }
     ...
     * @return int value
     */
    public int getTradeTypeValue() { return value; }

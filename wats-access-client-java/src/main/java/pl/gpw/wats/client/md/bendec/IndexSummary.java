...
public class IndexSummary implements ByteSerializable, Message {
    ...
    public static final int byteLength = 115;
    ...
    public IndexSummary(Header header, long instrumentId, long openingIndexValue, long sessionLow, long sessionHigh, long closingIndexValue, long sessionAvg, long pctChangeIndexValPrevSession, long pctChangeIndexValPrevYear, long closingCapitalisationPortfolio, long indIndexOpeningPortfolio) {
        ...
        this.header.setMsgType(MsgType.INDEXSUMMARY);
    }

    public IndexSummary(byte[] bytes, int offset) {
        this.header = new Header(bytes, offset);
        this.instrumentId = BendecUtils.uInt32FromByteArray(bytes, offset + 39);
        this.openingIndexValue = BendecUtils.int64FromByteArray(bytes, offset + 43);
        this.sessionLow = BendecUtils.int64FromByteArray(bytes, offset + 51);
        this.sessionHigh = BendecUtils.int64FromByteArray(bytes, offset + 59);
        this.closingIndexValue = BendecUtils.int64FromByteArray(bytes, offset + 67);
        this.sessionAvg = BendecUtils.int64FromByteArray(bytes, offset + 75);
        this.pctChangeIndexValPrevSession = BendecUtils.int64FromByteArray(bytes, offset + 83);
        this.pctChangeIndexValPrevYear = BendecUtils.int64FromByteArray(bytes, offset + 91);
        this.closingCapitalisationPortfolio = BendecUtils.int64FromByteArray(bytes, offset + 99);
        this.indIndexOpeningPortfolio = BendecUtils.int64FromByteArray(bytes, offset + 107);
        this.header.setLength(this.byteLength);
        this.header.setMsgType(MsgType.INDEXSUMMARY);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(header, instrumentId, openingIndexValue, sessionLow, sessionHigh, closingIndexValue, sessionAvg, pctChangeIndexValPrevSession, pctChangeIndexValPrevYear, closingCapitalisationPortfolio, indIndexOpeningPortfolio);
    }
